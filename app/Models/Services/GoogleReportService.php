...
use App\Exports\GoogleReportsExport;
...
class GoogleReportService extends ModelService
{
    ...
    public static function exportGoogleReport(
        string $from,
        string $to,
    ...
    {
        $date = date('Y-m-d');
        return (new GoogleReportsExport($from, $to, $platform))->download($date .'_google_reports.csv');
    }
}
