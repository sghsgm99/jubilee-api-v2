 ...
 */
class ArticleScroll extends Model implements ImageableInterface
{
    use HasFactory;
    use SoftDeletes;
    use ImageableTrait;
    ...
    public function Service(): ArticleScrollService
    {
        return new ArticleScrollService($this);
    }

    public function getRootDestinationPath(string $dir = null): string
    {
        $rootPath = "/articles/infinite-scrolls/{$this->id}";
