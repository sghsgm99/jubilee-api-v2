 ...
 */
class ArticleGallery extends Model implements ImageableInterface
{
    use HasFactory;
    use SoftDeletes;
    use ImageableTrait;
    ...
    public function Service(): ArticleGalleryService
    {
        return new ArticleGalleryService($this);
    }

    public function getRootDestinationPath(string $dir = null): string
    {
        $rootPath = "/articles/galleries/{$this->id}";
