...
/**
 * Class ArticleQuizzesResource.
 *
 * @property ArticleQuizzes $resource
 */
class ArticleQuizzesResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'answer_description' => $this->resource->answer_description,
