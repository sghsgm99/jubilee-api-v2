...
class RoleSerpConfigManagerSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $new_role_setup =
        [
            'page' => PageTypeEnum::SERP_CONFIG_MANAGER,
            'page_name' => 'SERP Configuration Manager',
            'permission' => [
        ...
        $role_setup[count($role->setup)] = $new_role_setup;
