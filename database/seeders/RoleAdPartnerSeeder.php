...
class RoleAdPartnerSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        /*$adpartners = [
            [
                ...
                'config' =>
                    [
                        'token_key' => 'e38ded5514f705b6b1d9a8552e8f6d654fafdfe515df8f647a11f54f737e237b',
                        'ocode' => '1510828',
                        'serve_url' => 'https://solutions.life123.com',
                    ]
            ],
            [
                'partner' => 'Google',
        ...
        foreach ($adpartners as $adpartner) {
            AdPartner::create([
                'partner' => $adpartner['partner'],
                'config' => $adpartner['config'],
            ]);
        }*/
    }
}
