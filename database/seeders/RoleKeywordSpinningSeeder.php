...
class RoleKeywordSpinningSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $new_role_setup =
        [
            'page' => PageTypeEnum::KEYWORDSPINNING,
            'page_name' => 'KeywordSpinning',
            'permission' => [
        ...
        $role_setup[PageTypeEnum::KEYWORDSPINNING - 1] = $new_role_setup;
